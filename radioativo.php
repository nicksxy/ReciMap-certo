...
<html lang="pt-br">
    <head>
        ...
        <title>ReciMap-radioativos</title>
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase">Radioativos</h1>
        ...
        <section class="projects-section bg-light" id="projects">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
                    <div class="col-xl-8 col-lg-7"><img class="img-fluid mb-3 mb-lg-0" src="./img/radioativo.jpg" alt="..." /></div>
                    <div class="col-xl-4 col-lg-5">
                        <div class="featured-text text-center text-lg-left">
                            <h4>Lixos Radioativos</h4>
                            <p class="text-black-100 mb-0">
É chamado de lixo radioativo, ou lixo nuclear, todo material residual que possui elementos químicos radioativos em sua composição, sendo obtido ao final de processos que ocorrem em hospitais, usinas nucleares ou em centros de pesquisas. O resíduo é o resultado de atividades realizadas com elementos radioativos como o urânio, e que oferece riscos à saúde humana e à natureza como um todo. Por conta do seu nível de perigo, 
o destino do lixo radioativo é regulado por organizações governamentais para garantir seu descarte correto.</p>
                        </div>
                    </div>
                </div>
                <!-- Project One Row-->
                <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="./img/radio.jpg" alt="..." /></div>
                    <div class="col-lg-6">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-left">
                                    <h4 class="text-white">Destino e Descarte do Lixo Nuclear</h4>
                                    <p class="mb-0 text-white-50">Os resíduos
                                         radioativos são classificados conforme o nível de radioatividade baixa, média ou alta e cada tipo possui um destino específico. Os de baixa e média radioatividade são armazenados em depósitos apropriados, enquanto os de alta radioatividade são colocados em piscinas de resfriamento protegidas por materiais como aço, chumbo e concreto. Apesar dessas medidas de segurança, o lixo nuclear continua sendo extremamente tóxico,
                                         podendo contaminar o ambiente e tornar certas áreas impróprias para a habitação por várias décadas.
</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row gx-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="./img/cesio137.jpg" alt="..." /></div>
                    <div class="col-lg-6 order-lg-first">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-right">
                                    <h4 class="text-white">Césio 137 Goiânia</h4>
                                    <p class="mb-0 text-white-50">O acidente com césio-137 que ocorreu em Goiânia, no ano de 1987, é o maior acidente radiológico do mundo. Dados oficiais apontam a morte de quatro pessoas em decorrência da exposição aguda ao elemento. O césio-137 foi retirado de um aparelho radiológico abandonado do antigo Instituto Goiano de Radiologia que posteriormente foi vendido a um ferro-velho. A partir daí, seu brilho azul fez com que ele se tornasse uma atração para diversos moradores da cidade. Aos poucos, contudo, eles perceberam o quão nocivo aquilo era, necessitando-se de rígidos protocolos de tratamento e de descarte da amostra radioativa.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="contact-section bg-black">
            <div class="container px-4 px-lg-5">
                ...
                <div class="social d-flex justify-content-center">
                     <a class="mx-2" href="https://www.tiktok.com/@senac.sp"><i class="fab fa-tiktok"></i></a>
