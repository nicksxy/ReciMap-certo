...
<html lang="pt-br">
    <head>
        ...
        <title>ReciMap-eletronicos</title>
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase">Eletronicos</h1>
        ...
        <section class="projects-section bg-light" id="projects">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
                    <div class="col-xl-8 col-lg-7"><img class="img-fluid mb-3 mb-lg-0" src="./img/eletronico.jpg "alt="..." /></div>
                    <div class="col-xl-4 col-lg-5">
                        <div class="featured-text text-center text-lg-left">
                            <h4>Lixos Eletrônicos</h4>
                            <p class="text-black-100 mb-0">O lixo eletrônico (e-lixo) ou tecnológico, como o próprio nome indica, é aquele proveniente de materiais eletrônicos. Ele também é conhecido pela sigla RAEE (Resíduos de Aparelhos Eletroeletrônicos).
Com o avanço da tecnologia no mundo moderno, há um excesso de lixo eletrônico os quais podem causar diversos impactos negativos no meio ambiente.      </p>
                        </div>
                    </div>
                </div>
                <!-- Project One Row-->
                <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="./img/eletronico2.jpg" alt="..." /></div>
                    <div class="col-lg-6">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-left">
                                    <h4 class="text-white">  Lixo Eletrônico e o Meio Ambiente</h4>
                                    <p class="mb-0 text-white-50">O lixo eletrônico é produzido por materiais de origem inorgânica, por exemplo, cobre, alumínio, metais pesados (mercúrio, cádmio, berílio e chumbo).
...
Além de poluir o ambiente, o contato com esses produtos pode acarretar diversas doenças para os animais e os seres humanos.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row gx-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="./img/eletronico3.jpg" alt="..." /></div>
                    <div class="col-lg-6 order-lg-first">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-right">
                                    <h4 class="text-white">Os Destinos Comuns do E-Lixo</h4>
                                    <p class="mb-0 text-white-50">Infelizmente, uma parte significativa do e-lixo acaba em aterros sanitários. Esse destino é problemático porque os aparelhos eletrônicos contêm materiais tóxicos, como chumbo, mercúrio e cádmio, que podem vazar e contaminar o solo e a água. Além disso,
                                         os aterros sanitários não permitem a recuperação de metais preciosos presentes nos dispositivos, como ouro e prata.</p>
                                </div>
                            </div>
                        </div>
                    </div>
