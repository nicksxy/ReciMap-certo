...
<html lang="pt-br">
    <head>
        ...
        <title>ReciMap-reciclaveis</title>
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase">Reciclaveis</h1>
        ...
        <section class="projects-section bg-light" id="projects">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
                    <div class="col-xl-8 col-lg-7"><img class="img-fluid mb-3 mb-lg-0" src="./img/reciclavel.jpg" alt="..." /></div>
                    <div class="col-xl-4 col-lg-5">
                        <div class="featured-text text-center text-lg-left">
                            <h4>Lixos Recicláveis </h4>
                            <p class="text-black-100 mb-0"> O lixo reciclável refere-se a materiais que podem ser processados e transformados em novos produtos. Dentre os principais materiais recicláveis estão plástico, papel, vidro e 
                                metal. Identificar esses materiais corretamente é crucial para a eficácia dos programas de reciclagem.</p>
                ...
                <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="./img/reciclavel6.jpg" alt="..." /></div>
                    <div class="col-lg-6">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-left">
                                    <h4 class="text-white">O que pode ser reciclado?</h4>
                                    <p class="mb-0 text-white-50"> Papel: papelão, caixas em geral, papel escritório, jornais, revistas, livros, cadernos (sem espiral e sem capa).

Plástico: sacos plásticos, embalagens de produtos de limpeza, garrafa PET, baldes, bacias, mesas plásticas.

Metal: latas de alumínio (refrigerante, suco, cerveja), latas de produtos alimentícios (óleo, leite em pó, conservas) e folha de flandres.

Óleo vegetal: óleo de cozinha, material deve ser entregue filtrado e armazenado em garrafas PET transparente.

Eletrônico: CPU/gabinete com placa mãe, notebook, DVD, televisores, monitores, celular, tablet, teclado, mouse, impressoras, rádio, ventilador, copiadores etc.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row gx-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="./img/reciclavel4.jpg" alt="..." /></div>
                    <div class="col-lg-6 order-lg-first">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-right">
                                    <h4 class="text-white">Qual é a importância e os benefícios da reciclagem por material?</h4>
                                    <p class="mb-0 text-white-50">A reciclagem é fundamental porque promove benefícios sociais, econômicos e ambientais. Ela gera empregos, estimula a economia e reduz a quantidade de lixo enviada aos aterros sanitários, prolongando a vida útil desses locais. Além disso, economiza energia, diminui o uso de matérias-primas naturais muitas vezes não renováveis 
                                         e contribui para a preservação do meio ambiente, reduzindo o desmatamento, a poluição e os danos ao solo.</p>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4 mx-auto" />
                               <div class="small text-black-50"><a href="https://www.sp.senac.br/senac-sao-jose-dos-campos">sjcampos@sp.senac.br</a></div>
            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
