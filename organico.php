            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase">Organicos</h1>
        ...
        <section class="projects-section bg-light" id="projects">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
                    <div class="col-xl-8 col-lg-7"><img class="img-fluid mb-3 mb-lg-0" src="./img/organico.jpg" alt="..." /></div>
                    <div class="col-xl-4 col-lg-5">
                        <div class="featured-text text-center text-lg-left">
                            <h4>Lixos Orgânicos</h4>
                            <p class="text-black-100 mb-0">Fazem parte do lixo orgânico todos os resíduos que têm origem animal ou vegetal: restos de alimento, folhas, sementes, restos de carne, ossos, 
                                entre outros, que sofrem um processo de decomposição natural, sumindo da natureza em pouco tempo.</p>
                        </div>
                    </div>
                </div>
                <!-- Project One Row-->
                <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="img/organico2.jpg" alt="..." /></div>
                    <div class="col-lg-6">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-left">
                                    <h4 class="text-white">Coleta e Tratamento do Lixo Orgânico</h4>
                                    <p class="mb-0 text-white-50">Depois de coletado pelo serviço público, geralmente o lixo orgânico é levados para locais próprios chamados de aterros sanitários.
...
Com a decomposição de resíduos orgânicos metano (CH4) é produzido. O metano é um gás tóxico incolor e inodoro, que contribui para o aumento do efeito estufa no planeta.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row gx-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="img/organico3.jpg" alt="..." /></div>
                    <div class="col-lg-6 order-lg-first">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-right">
                                    <h4 class="text-white">Forma de descarte do lixo orgânico</h4>
                                    <p class="mb-0 text-white-50">O manejo correto do lixo orgânico traz benefícios ambientais, sociais e econômicos, ajudando a reduzir a contaminação do solo e da água, minimizar a emissão de gases de efeito estufa e promover a economia circular. 

Quando descartado de maneira adequada, esse tipo de resíduo pode ser reaproveitado de diversas formas, evitando a sobrecarga de aterros sanitários e incentivando soluções mais sustentáveis. </p>
                                </div>
                            </div>
                        </div>
                    </div>
