...
<body id="page-top">
    ...
    <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
      <div class="d-flex justify-content-center">
        <div class="text-center">
          <h1 class="mx-auto my-0 text-uppercase">ReciMap</h1>
  ...
  <section class="projects-section bg-light py-3" id="projects">
    <div class="container px-4 px-lg-5">

      <!-- Featured Project Row-->
      <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
        <div class="col-xl-8 col-lg-7"><img class="img-fluid mb-3 mb-lg-0" src="./img/imgreci.jpg" alt="..." /></div>
        <div class="col-xl-4 col-lg-5">
          <div class="featured-text text-center text-lg-left">
            <h4>Sobre-nós</h4>
            <p class="text-black-100 mb-0">Nosso propósito é educar, inspirar e mobilizar pessoas para o descarte correto de diferentes tipos de lixo seja reciclável, orgânico, eletrônico ou perigoso.

              Vivemos em um mundo onde o consumo cresce a cada dia, e com ele, o volume de resíduos. Pensando nisso, criamos este espaço para informar de forma simples e acessível sobre como cada um pode contribuir para um planeta mais limpo e sustentável.


              Aqui, você encontra:
              ♻️ Guias práticos de separação e destinação de resíduos.
              🌍 Dicas sustentáveis para o dia a dia.
              💡 Curiosidades e notícias sobre reciclagem e meio ambiente.
              📍 Locais de coleta e pontos de descarte próximos a você.

              Nosso objetivo é mostrar que cuidar do meio ambiente começa com ações cotidianas e o primeiro passo é saber onde e como descartar corretamente o que já não serve mais.

              Junte-se a nós e faça parte dessa mudança! 🌿.</p>
          </div>
        </div>
        <style>
          .mapa_resp {
      ...
      <iframe class="mapa_resp"


        src="mapa_conteudo.php"


        scrolling="no"></iframe>


      <!-- TODO o conteúdo do mapa aqui -->
    </div>
  ...
  <footer class="footer bg-black small text-center text-white-50">
    <div class="container px-4 px-lg-5">Copyright &copy; Todos Direitos Reservados 2025</div>
  </footer>
  <!-- Bootstrap core JS-->
